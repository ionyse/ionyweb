...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PageApp_GalleryImages'
        db.create_table('page_gallery_images_pageapp_galleryimages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('show_album_title', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('page_gallery_images', ['PageApp_GalleryImages'])

        # Adding model 'Album'
        db.create_table('page_gallery_images_album', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(related_name='albums', to=orm['page_gallery_images.PageApp_GalleryImages'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal('page_gallery_images', ['Album'])

        # Adding unique constraint on 'Album', fields ['app', 'slug']
        db.create_unique('page_gallery_images_album', ['app_id', 'slug'])

        # Adding model 'Image'
        db.create_table('page_gallery_images_image', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('album', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['page_gallery_images.Album'])),
        ...
        db.send_create_signal('page_gallery_images', ['Image'])

    def backwards(self, orm):
        # Removing unique constraint on 'Album', fields ['app', 'slug']
        db.delete_unique('page_gallery_images_album', ['app_id', 'slug'])

        # Deleting model 'PageApp_GalleryImages'
        db.delete_table('page_gallery_images_pageapp_galleryimages')

        # Deleting model 'Album'
        db.delete_table('page_gallery_images_album')

        # Deleting model 'Image'
        db.delete_table('page_gallery_images_image')
