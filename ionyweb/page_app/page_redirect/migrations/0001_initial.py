...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PageApp_Redirect'
        db.create_table('page_redirect_pageapp_redirect', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('page_redirect', ['PageApp_Redirect'])


    def backwards(self, orm):
        
        # Deleting model 'PageApp_Redirect'
        db.delete_table('page_redirect_pageapp_redirect')
    ...
    models = {
        ...
        'page_redirect.pageapp_redirect': {
            'Meta': {'object_name': 'PageApp_Redirect'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
