...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PageApp_Sitemap'
        db.create_table('page_sitemap_pageapp_sitemap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('page_sitemap', ['PageApp_Sitemap'])


    def backwards(self, orm):
        
        # Deleting model 'PageApp_Sitemap'
        db.delete_table('page_sitemap_pageapp_sitemap')
    ...
    models = {
        ...
        'page_sitemap.pageapp_sitemap': {
            'Meta': {'object_name': 'PageApp_Sitemap'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sites.site': {
