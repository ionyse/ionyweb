...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebSite.in_maintenance'
        db.add_column('website_website', 'in_maintenance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'WebSite.in_maintenance'
        db.delete_column('website_website', 'in_maintenance')
