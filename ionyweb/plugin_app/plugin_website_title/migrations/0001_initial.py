...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Plugin_WebsiteTitle'
        db.create_table('plugin_website_title_plugin_websitetitle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('baseline', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('plugin_website_title', ['Plugin_WebsiteTitle'])


    def backwards(self, orm):
        
        # Deleting model 'Plugin_WebsiteTitle'
        db.delete_table('plugin_website_title_plugin_websitetitle')
