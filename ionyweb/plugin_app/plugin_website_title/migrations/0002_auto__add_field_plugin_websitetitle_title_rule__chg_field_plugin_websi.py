...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_WebsiteTitle.title_rule'
        db.add_column('plugin_website_title_plugin_websitetitle', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Plugin_WebsiteTitle.title'
        db.alter_column('plugin_website_title_plugin_websitetitle', 'title', self.gf('django.db.models.fields.CharField')(max_length=100))
    def backwards(self, orm):
        # Deleting field 'Plugin_WebsiteTitle.title_rule'
        db.delete_column('plugin_website_title_plugin_websitetitle', 'title_rule')


        # Changing field 'Plugin_WebsiteTitle.title'
        db.alter_column('plugin_website_title_plugin_websitetitle', 'title', self.gf('django.db.models.fields.CharField')(max_length=150))
    models = {
        'auth.group': {
