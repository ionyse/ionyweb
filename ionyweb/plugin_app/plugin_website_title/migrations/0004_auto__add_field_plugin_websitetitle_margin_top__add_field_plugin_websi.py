...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_WebsiteTitle.margin_top'
        db.add_column('plugin_website_title_plugin_websitetitle', 'margin_top',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_WebsiteTitle.margin_bottom'
        db.add_column('plugin_website_title_plugin_websitetitle', 'margin_bottom',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_WebsiteTitle.margin_top'
        db.delete_column('plugin_website_title_plugin_websitetitle', 'margin_top')

        # Deleting field 'Plugin_WebsiteTitle.margin_bottom'
        db.delete_column('plugin_website_title_plugin_websitetitle', 'margin_bottom')
    ...
    models = {
        ...
        'plugin_website_title.plugin_websitetitle': {
            ...
            'margin_bottom': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'margin_top': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
