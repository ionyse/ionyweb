...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Contact.title_rule'
        db.add_column('plugin_contact_plugin_contact', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_Contact.title_rule'
        db.delete_column('plugin_contact_plugin_contact', 'title_rule')
