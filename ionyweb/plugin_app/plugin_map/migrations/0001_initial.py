...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Plugin_Map'
        db.create_table('plugin_map_plugin_map', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('map_lat', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('map_lon', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('window_open', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('zoom', self.gf('django.db.models.fields.IntegerField')(default=17)),
        ...
        db.send_create_signal('plugin_map', ['Plugin_Map'])


    def backwards(self, orm):
        
        # Deleting model 'Plugin_Map'
        db.delete_table('plugin_map_plugin_map')
    ...
    models = {
        ...
        'plugin_map.plugin_map': {
            'Meta': {'object_name': 'Plugin_Map'},
            'address': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'height': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map_lat': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'map_lon': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'width': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'window_open': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'zoom': ('django.db.models.fields.IntegerField', [], {'default': '17'})
        },
        'sites.site': {
