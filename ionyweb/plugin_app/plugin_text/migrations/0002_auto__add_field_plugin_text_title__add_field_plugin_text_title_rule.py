...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Text.title'
        db.add_column('plugin_text_plugin_text', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Text.title_rule'
        db.add_column('plugin_text_plugin_text', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_Text.title'
        db.delete_column('plugin_text_plugin_text', 'title')

        # Deleting field 'Plugin_Text.title_rule'
        db.delete_column('plugin_text_plugin_text', 'title_rule')
