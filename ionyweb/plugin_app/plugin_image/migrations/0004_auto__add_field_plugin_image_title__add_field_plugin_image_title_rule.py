...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Image.title'
        db.add_column('plugin_image_plugin_image', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Image.title_rule'
        db.add_column('plugin_image_plugin_image', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_Image.title'
        db.delete_column('plugin_image_plugin_image', 'title')

        # Deleting field 'Plugin_Image.title_rule'
        db.delete_column('plugin_image_plugin_image', 'title_rule')
    ...
    models = {
        ...
        'plugin_image.plugin_image': {
            'Meta': {'object_name': 'Plugin_Image'},
            'alignment': ('django.db.models.fields.CharField', [], {'default': "'C'", 'max_length': '1'}),
