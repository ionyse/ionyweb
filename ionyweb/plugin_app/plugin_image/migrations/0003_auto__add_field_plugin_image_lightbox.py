...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Image.lightbox'
        db.add_column('plugin_image_plugin_image', 'lightbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_Image.lightbox'
        db.delete_column('plugin_image_plugin_image', 'lightbox')
