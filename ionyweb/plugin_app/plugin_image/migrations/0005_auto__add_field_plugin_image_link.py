...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Image.link'
        db.add_column('plugin_image_plugin_image', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plugin_Image.link'
        db.delete_column('plugin_image_plugin_image', 'link')
