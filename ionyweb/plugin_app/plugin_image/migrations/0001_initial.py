...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plugin_Image'
        db.create_table('plugin_image_plugin_image', (
        ...
        db.send_create_signal('plugin_image', ['Plugin_Image'])

    def backwards(self, orm):
        # Deleting model 'Plugin_Image'
        db.delete_table('plugin_image_plugin_image')
