...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_Slideshow.title'
        db.add_column('plugin_slideshow_plugin_slideshow', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_Slideshow.title_rule'
        db.add_column('plugin_slideshow_plugin_slideshow', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_Slideshow.title'
        db.delete_column('plugin_slideshow_plugin_slideshow', 'title')

        # Deleting field 'Plugin_Slideshow.title_rule'
        db.delete_column('plugin_slideshow_plugin_slideshow', 'title_rule')
