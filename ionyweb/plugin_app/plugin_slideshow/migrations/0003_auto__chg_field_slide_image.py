...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('plugin_slideshow_slide', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Slide.image'
        db.alter_column('plugin_slideshow_slide', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=200))
