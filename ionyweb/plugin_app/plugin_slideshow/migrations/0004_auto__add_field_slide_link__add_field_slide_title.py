...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('plugin_slideshow_slide', 'link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'Slide.title'
        db.add_column('plugin_slideshow_slide', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('plugin_slideshow_slide', 'link')

        # Deleting field 'Slide.title'
        db.delete_column('plugin_slideshow_slide', 'title')
