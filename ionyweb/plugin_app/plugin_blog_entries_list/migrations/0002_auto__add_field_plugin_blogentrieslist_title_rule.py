...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_BlogEntriesList.title_rule'
        db.add_column('plugin_blog_entries_list_plugin_blogentrieslist', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_BlogEntriesList.title_rule'
        db.delete_column('plugin_blog_entries_list_plugin_blogentrieslist', 'title_rule')
    ...
    models = {
        ...
        'page_blog.entry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modification_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'publication_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 11, 0, 0)', 'db_index': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255'}),
