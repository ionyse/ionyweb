...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_FbLikebox.title'
        db.add_column('plugin_fb_likebox_plugin_fblikebox', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Plugin_FbLikebox.title_rule'
        db.add_column('plugin_fb_likebox_plugin_fblikebox', 'title_rule',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_FbLikebox.title'
        db.delete_column('plugin_fb_likebox_plugin_fblikebox', 'title')

        # Deleting field 'Plugin_FbLikebox.title_rule'
        db.delete_column('plugin_fb_likebox_plugin_fblikebox', 'title_rule')
    ...
    models = {
        ...
        'plugin_fb_likebox.plugin_fblikebox': {
            'Meta': {'object_name': 'Plugin_FbLikebox'},
            'colorscheme': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'show_faces': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
    ...
    complete_apps = ['plugin_fb_likebox']