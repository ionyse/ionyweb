...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Plugin_FbLikebox'
        db.create_table('plugin_fb_likebox_plugin_fblikebox', (
            ...
            ('colorscheme', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('show_faces', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('plugin_fb_likebox', ['Plugin_FbLikebox'])


    def backwards(self, orm):
        
        # Deleting model 'Plugin_FbLikebox'
        db.delete_table('plugin_fb_likebox_plugin_fblikebox')
