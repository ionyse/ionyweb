...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Plugin_Breadcrumb'
        db.create_table('plugin_breadcrumb_plugin_breadcrumb', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('separator', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('ancestors_displayed', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('links_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('plugin_breadcrumb', ['Plugin_Breadcrumb'])


    def backwards(self, orm):
        
        # Deleting model 'Plugin_Breadcrumb'
        db.delete_table('plugin_breadcrumb_plugin_breadcrumb')
    ...
    models = {
        ...
        'plugin_breadcrumb.plugin_breadcrumb': {
            'Meta': {'object_name': 'Plugin_Breadcrumb'},
            'ancestors_displayed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'links_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'separator': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'})
        },
        'sites.site': {
    ...
    complete_apps = ['plugin_breadcrumb']
