...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Plugin_LinksList'
        db.create_table('plugin_links_list_plugin_linkslist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
        ))
        db.send_create_signal('plugin_links_list', ['Plugin_LinksList'])

        # Adding model 'Link'
        db.create_table('plugin_links_list_link', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('plugin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links', to=orm['plugin_links_list.Plugin_LinksList'])),
        ...
        db.send_create_signal('plugin_links_list', ['Link'])


    def backwards(self, orm):
        
        # Deleting model 'Plugin_LinksList'
        db.delete_table('plugin_links_list_plugin_linkslist')

        # Deleting model 'Link'
        db.delete_table('plugin_links_list_link')
    ...
    models = {
        ...
        'plugin_links_list.link': {
            'Meta': {'object_name': 'Link'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'plugin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'links'", 'to': "orm['plugin_links_list.Plugin_LinksList']"}),
            'target': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'plugin_links_list.plugin_linkslist': {
            'Meta': {'object_name': 'Plugin_LinksList'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    ...
    complete_apps = ['plugin_links_list']
