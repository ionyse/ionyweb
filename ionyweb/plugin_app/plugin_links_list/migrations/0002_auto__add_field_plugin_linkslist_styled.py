...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plugin_LinksList.styled'
        db.add_column('plugin_links_list_plugin_linkslist', 'styled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Plugin_LinksList.styled'
        db.delete_column('plugin_links_list_plugin_linkslist', 'styled')
    ...
    models = {
        ...
        'plugin_links_list.plugin_linkslist': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'styled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
