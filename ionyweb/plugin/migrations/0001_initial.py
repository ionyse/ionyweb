...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PluginRelation'
        db.create_table('plugin_pluginrelation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('placeholder_slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, blank=True)),
            ('plugin_order', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('plugin', ['PluginRelation'])

        # Adding M2M table for field pages on 'PluginRelation'
        db.create_table('plugin_pluginrelation_pages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pluginrelation', models.ForeignKey(orm['plugin.pluginrelation'], null=False)),
            ('page', models.ForeignKey(orm['page.page'], null=False))
        ))
        db.create_unique('plugin_pluginrelation_pages', ['pluginrelation_id', 'page_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'PluginRelation'
        db.delete_table('plugin_pluginrelation')

        # Removing M2M table for field pages on 'PluginRelation'
        db.delete_table('plugin_pluginrelation_pages')
    ...
    models = {
        ...
        'plugin.websitepluginrelation': {
            'Meta': {'object_name': 'WebsitePluginRelation'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'placeholder_slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True'}),
            'plugin_order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'website': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': "orm['website.WebSite']"})
        },
        'sites.site': {
